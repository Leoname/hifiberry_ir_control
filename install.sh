...
cp beocreate/beo-extensions/ir-remote-control/menu.html "$BEOCREATE_EXT_DIR/"
cp beocreate/beo-extensions/ir-remote-control/ir-remote-client.js "$BEOCREATE_EXT_DIR/"
